...
Date: 2020-06-18 13:59:04
Added blockchain properties in the following tables:
author
author_income
book
user
...
-- Added blockchain blockchain_address
-- ----------------------------
DROP TABLE IF EXISTS `author`;
CREATE TABLE `author` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `user_id` bigint(20) DEFAULT NULL COMMENT '用户ID',
  `blockchain_address` varchar(42) DEFAULT NULL COMMENT '用户区块链地址0x开头',
...
-- ----------------------------
INSERT INTO `author_code` VALUES ('3', 'raindeer123', '2020-05-27 22:43:45', '1', '2020-05-13 11:40:56', '1');
...
-- 增加作者区块链地址和书的合约地址
-- `author_address` varchar(42) DEFAULT NULL COMMENT '作者的用户区块链地址0x开头',
-- `blockchain_address` varchar(42) DEFAULT NULL COMMENT '作品区块链合约地址0x开头',
-- ----------------------------
...
INSERT INTO `book_comment` VALUES ('12', '1254954626689150976', '测试评论002', '0', '0', '2020-04-30 08:35:53', '1255060328322027520');
...
-- Records of sys_dept
-- ----------------------------
INSERT INTO `sys_dept` VALUES ('13', '0', '技术服务部', '5', '1');
INSERT INTO `sys_dept` VALUES ('14', '13', '运维管理部', '1', '1');
INSERT INTO `sys_dept` VALUES ('15', '13', '市场部', '2', '1');
INSERT INTO `sys_dept` VALUES ('16', '13', '编辑部', '13', '1');
...
CREATE TABLE `sys_gen_columns` (
  ...
  `column_label` varchar(64) DEFAULT NULL COMMENT '列标签',
...
CREATE TABLE `user` (
  ...
  `blockchain_address` varchar(42) DEFAULT NULL COMMENT '用户区块链地址0x开头',
  `token_balance` bigint(20) DEFAULT NULL COMMENT '区块链上的稳定币数量',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1260400284744613891', '13512345678', 'e10adc3949ba59abbe56e057f20f883e', '测试1', '0x7312f4b8a4457a36827f185325fd6b66a3f8bb8b', null, null, null, '0', '0', '2021-05-28 17:04:35', '2021-05-28 17:04:35');
INSERT INTO `user` VALUES ('1413956884249956352','15345678902','96e79218965eb72c92a549dd5a330112', '15345678902', '0xa8863fc8ce3816411378685223c03daae9770ebb', '102', null ,'0','201','0','2021-07-11 04:22:46','2021-07-11 08:59:0');
...
-- ----------------------------
INSERT INTO `user_bookshelf` VALUES ('37', '1255060328322027520', '1254957312633352192', 'null','3335449', '2020-04-30 07:27:23', '2020-04-30 19:37:36');
INSERT INTO `user_bookshelf` VALUES ('38', '1255664783722586112', '1254674396451897344', 'null','1254674396690972672', '2020-04-30 09:06:53', '2020-04-30 09:06:59');
INSERT INTO `user_bookshelf` VALUES ('39', '1255060328322027520', '1254681071191785472', 'null','1254681071552495616', '2020-04-30 09:37:47', null);
INSERT INTO `user_bookshelf` VALUES ('40', '1255060328322027520', '1254676970567565312', 'null','3264258', '2020-04-30 09:57:18', '2020-04-30 19:19:11');
INSERT INTO `user_bookshelf` VALUES ('41', '1255060328322027520', '1254675594315759616', 'null','1254675594496114688', '2020-04-30 18:37:18', null);
...
-- ----------------------------
INSERT INTO `user_feedback` VALUES ('8', '1255060328322027520', '一般，比较水', '2021-04-30 08:58:49');
